...
Public Class CodeTracker
    ...
    Public Sub AddMalloc(CodeLine As String, FileName As String)
    ...
    Public Sub AddFree(CodeLine As String, FileName As String)
    ...
    Public Sub AddNew(CodeLine As String, FileName As String)
        ' Take the variable name and its details and add them to the list
        '================================================================
        Dim strVarName As String = ""
        Dim strDescription As String = ""
    ...
    Public Sub AddDelete(CodeLine As String, FileName As String)
    ...
    Public Sub AddBuffer(CodeLine As String, Optional BuffType As String = "(char|TCHAR|BYTE)")
        ' Take the variable name and its details and add them to the list
        '================================================================
        Dim strVarName As String = ""
        Dim strDescription As String = ""
    ...
    Public Sub AddCharStar(CodeLine As String, Optional BuffType As String = "(char|TCHAR|BYTE)")
        ' Take the variable name and its details and add them to the list
        '================================================================
        Dim strVarName As String = ""
        Dim strDescription As String = "*"
    ...
    Public Sub AddPointer(CodeLine As String, Optional BuffType As String = "POINTER")
        ' Take the variable name and its details and add them to the list
    ...
    Public Sub AddPIC(CodeLine As String)
    ...
    Public Function CheckCOBOLSignedComp(CodeLine As String) As Boolean
    ...
    Public Sub AddInteger(CodeLine As String)
        ' Take the variable name and its details and add them to the list
        '================================================================
        Dim strDescription As String = ""
    ...
    Public Sub CheckOverflow(CodeLine As String, FileName As String)
...
NextLoop:
    ...
    Private Function GetStrncpyLimit(BufferSize As String, SourceName As String, DestName As String, IsStrncat As Boolean) As Integer
    ...
    Private Function CompareBufferLengths(SourceBuffer As String, DestinationBuffer As String, Optional IsStrN As Boolean = False, Optional SizeLimit As Integer = 0, Optional IsCat As Boolean = False) As Integer
    ...
    Private Function GetBufferLength(BufferName As String) As Integer
    ...
    Private Function GetInteger(VarName As String) As Integer
    ...
    Public Function CheckSignedComp(CodeLine As String) As Integer
        ' Get status of numeric variables - signed or unsigned
        ' Return true if signed is compared with unsigned, otherwise return false
        '========================================================================
    ...
    Private Function TrimOperators(VarName As String) As String
